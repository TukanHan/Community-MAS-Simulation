...
{
    [CustomPropertyDrawer(typeof(RangeNoiseMapParameters))]
    public class RangeNoiseMapParametersDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            if (property.isExpanded = EditorGUI.Foldout(foldoutRect, property.isExpanded, label, true))
            {
                ...
                EditorGUI.MinMaxSlider(rowsPositions[2], new GUIContent("Value range",
