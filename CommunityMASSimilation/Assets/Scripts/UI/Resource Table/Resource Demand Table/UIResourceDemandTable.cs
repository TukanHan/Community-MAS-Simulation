...
namespace UI.ResourceTable.Demand
{
    public class UIResourceDemandTable : SingletonBehaviour<UIResourceDemandTable>, IUIPanel
    {
        public GameObject demandRowPrefab;
        ...
        public void Enable(object[] data)
        {
            ...
            BuildRows(demandRowPrefab);
        }

        private void BuildRows(GameObject rowPrefab)
        {
