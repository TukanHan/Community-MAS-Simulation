...
{
    public class UIResourcePriceTable : SingletonBehaviour<UIResourcePriceTable>, IUIPanel
    {
        public UIResourcePriceTableRow saleRowPrefab;
        ...
        private void BuildRows()
        {
            ...
            {
                GameObject go = Instantiate(saleRowPrefab.gameObject, contentPanel);
